  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-gradient-to-br from-slate-950 via-slate-900 to-slate-800 px-4 text-white">
      <div className="max-w-xl rounded-[2rem] border border-white/10 bg-white/5 p-8 text-center backdrop-blur">
        ...
        <p className="mt-4 text-slate-300">We could not reach the CA API. Check your connection and try again.</p>
        <Link to="/login" className="mt-8 inline-flex rounded-full bg-indigo-500 px-5 py-3 text-sm font-semibold text-white hover:bg-indigo-400">
          Return to login
        </Link>
      </div>
    </div>
